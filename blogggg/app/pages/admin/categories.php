...
<div class="col-md-6 mx-auto">
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-floating">
          <select name="disabled" class="form-select mb-2">
        ...
        <a href="<?=ROOT?>/admin/categories">
          <button class="btn btn-primary mt-4 py-2" type="button">Back</button>
        </a>
        <button class="btn btn-primary float-end mt-4 py-2" type="submit">Create</button>
  ...
  <form method="post">
    ...
    <?php if(!empty($row)):?>
        ...
        <?php endif;?>
         ...
         <button class="btn btn-primary float-end mt-4 py-2" type="submit">Save</button>
    <?php else:?>
...
<div class="col-md-6 mx-auto">
  <form method="post">
    ...
    <?php if(!empty($row)):?>
         ...
         <button class="btn btn-danger float-end mt-4 py-2" type="submit">Delete</button>
    <?php else:?>
