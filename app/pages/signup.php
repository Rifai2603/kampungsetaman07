...
<main class="form-signin w-100 m-auto">
  <form method="post">
    <a href="home">
      <img class="mb-4 rounded-circle shadow" src="<?=ROOT?>/assets/images/logo_setaman.png" alt="" width="92" height="77" style="object-fit: cover;">
    </a>
    ...
    <div class="my-2">Already have an account? <a href="<?=ROOT?>/login">Login here</div>
    ...
    <p class="mt-5 mb-3 text-body-secondary" align="center">&copy; <?= date("Y")?></p>
  </form>
</main>
