...
<main class="form-signin w-100 m-auto">
  <form method="post">
    <a href="home">
    <img class="mb-4 rounded-circle shadow" src="<?=ROOT?>/assets/images/logo_setaman.png" alt="" width="92" height="92" style="object-fit: cover;">
    </a>
    ...
    <!--<div class="my-2">Dont have an account? <a href="<?=ROOT?>/signup">Signup here</div> -->
